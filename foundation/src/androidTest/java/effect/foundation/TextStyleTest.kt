...
class TextStyleTest : ComposeTest() {
    ...
    fun contains_textStyle() = compose {
        ...
        setContent {
            View { Box(modifier = Modifier.testTag(LocalTextStyle.current.toString())) }
                .textStyle(expected)
                .Compose()
        }
    ...
    fun contains_maxLines() = compose {
        ...
        setContent {
            View { Box(modifier = Modifier.testTag(LocalMaxLines.current.toString())) }
                .maxLines(expected)
                .Compose()
        }
        onNodeWithTag(expected.toString()).assertExists()
    ...
    fun contains_softWrap() = compose {
        ...
        setContent {
            View { Box(modifier = Modifier.testTag(LocalSoftWrap.current.toString())) }
                .softWrap(expected)
                .Compose()
        }
        onNodeWithTag(expected.toString()).assertExists()
    ...
    fun contains_textOverflow() = compose {
        ...
        setContent {
            View { Box(modifier = Modifier.testTag(LocalTextOverflow.current.toString())) }
    ...
    fun contains_enabled() = compose {
        val expected = nextBoolean()
        setContent {
            View { Box(modifier = Modifier.testTag(LocalEnabled.current.toString())) }
                .enabled(expected)
                .Compose()
        }
        onNodeWithTag(expected.toString()).assertExists()
    ...
    fun contains_readOnly() = compose {
        val expected = nextBoolean()
        setContent {
            View { Box(modifier = Modifier.testTag(LocalReadOnly.current.toString())) }
                .readOnly(expected)
                .Compose()
        }
        onNodeWithTag(expected.toString()).assertExists()
    ...
    fun contains_keyboardOptions() = compose {
        ...
        setContent {
            View { Box(modifier = Modifier.testTag(LocalKeyboardOptions.current.toString())) }
    ...
    fun contains_keyboardActions() = compose {
        ...
        setContent {
            View { Box(modifier = Modifier.testTag(LocalKeyboardActions.current.toString())) }
    ...
    fun contains_visualTransformation() = compose {
        ...
        setContent {
            View { Box(modifier = Modifier.testTag(LocalVisualTransformation.current.toString())) }
    ...
    fun contains_cursorBrush() = compose {
        ...
        setContent {
            View { Box(modifier = Modifier.testTag(LocalCursorBrush.current.toString())) }
